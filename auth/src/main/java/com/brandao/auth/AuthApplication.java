...
import com.brandao.auth.entity.Permission;
import com.brandao.auth.entity.User;
import com.brandao.auth.repository.PermissionRepository;
import com.brandao.auth.repository.UserRepository;
...
public class AuthApplication {
	...
	private void initUsers(UserRepository userRepository, PermissionRepository permissionRepository,
		...
		User find = userRepository.findByUserName("brandao");
		if (find == null) {
